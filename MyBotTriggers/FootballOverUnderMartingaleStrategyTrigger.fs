...
module FootballOverUnderMartingaleStrategyTrigger
...
let getMarketSettledProfit(market : Market) =
    ...
    then
        ...
        then
            // Is this a good implementation for more winners market?
...
/// <summary>
/// FootballOverUnderMartingaleStrategyTrigger
/// </summary>
type FootballOverUnderMartingaleStrategyTrigger(market : Market, selection : Selection, botName : string, botTriggerParameters : BotTriggerParameters, myBfexplorer : IMyBfexplorer) =
        ...
        member this.Execute() =
            let result =
                ...
                | TriggerStatus.StartMyStrategy ->
                    ...
                    ExecuteMyActionBotOnMarketSelectionAndContinueToExecute (botName, executingOnMarket, executingOnMarket.Selections.[ExecuteOnSelection], myBotParameters, true)
